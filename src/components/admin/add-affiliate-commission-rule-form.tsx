...
import { createAffiliateCommissionRuleAction } from "@/domains/affiliates/actions";
import { useRouter } from "@/i18n/navigation";

type OrganizationOption = { id: string; name: string };

export function AddAffiliateCommissionRuleForm({
  locale,
  organizations,
}: {
  locale: string;
  ...
  async function handleSubmit() {
    ...
    try {
      await createAffiliateCommissionRuleAction(locale, {
